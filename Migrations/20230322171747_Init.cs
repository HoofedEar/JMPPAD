        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArtCrop = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMultiFaced = table.Column<bool>(type: "INTEGER", nullable: true),
                    Loyalty = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CubeId = table.Column<Guid>(type: "TEXT", nullable: false),
                    DeckId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CubeContents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOfficial = table.Column<bool>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeckContents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeckContents_Cards_CardId",
                        column: x => x.CardId,
                        principalTable: "Cards",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DeckContents_Decks_DeckId",
                        column: x => x.DeckId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeckContents_CardId",
                table: "DeckContents",
                column: "CardId");

            migrationBuilder.CreateIndex(
                name: "IX_DeckContents_DeckId",
                table: "DeckContents",
                column: "DeckId");
